...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            if isinstance(self.agent, DQNAgent):
                ...
                paths, envsteps_this_batch, train_video_paths = self.collect_training_trajectories(itr,
                                                       initial_expertdata, collect_policy, self.params['batch_size'])
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        ...
        if not itr and load_initial_expertdata:
            print("Loading from file ", load_initial_expertdata)
        ...
        paths, envsteps_this_batch = sample_trajectories(self.env, collect_policy, batch_size, self.params['ep_len'], False)
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        for transition in paths:
            transition["action"] = expert_policy.get_action(transition["observation"])
        return paths
